...
export const quickReferenceCommands = [
  { cmd: '/cook', desc: 'Full feature implementation', variants: ':fast, :hard' },
  { cmd: '/fix', desc: 'Bug fix with investigation', variants: ':fast, :hard' },
  { cmd: '/test', desc: 'Generate test suites', variants: ':fast, :hard' },
  { cmd: '/review', desc: 'Code review', variants: ':fast, :hard' },
  { cmd: '/plan', desc: 'Create implementation plan', variants: ':fast, :hard' },
  { cmd: '/debug', desc: 'Root cause analysis', variants: ':fast, :hard' },
