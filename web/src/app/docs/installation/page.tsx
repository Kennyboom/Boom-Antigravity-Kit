...
export const metadata = {
  title: "Installation | Boom Antigravity Kit",
  description: "Get started with Boom Antigravity Kit in under a minute.",
};
    ...
    <div className="max-w-3xl">
      ...
      <section id="quick-start" className="mb-12 scroll-mt-16">
        ...
        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
          The fastest way to install Boom Antigravity Kit is using <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">npx</code> in root project:
        </p>
...
└── ARCHITECTURE.md  # Full documentation`}
      ...
      <section className="mb-12">
        ...
        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
          Now that you have Boom Antigravity Kit installed, learn about the core concepts:
        </p>
