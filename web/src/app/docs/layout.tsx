...
export const metadata: Metadata = {
    title: "Documentation | Boom Antigravity Kit",
    description: "Complete documentation for Boom Antigravity Kit - AI Agent templates with Skills, Agents, and Workflows.",
};
