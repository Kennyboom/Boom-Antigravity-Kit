        ...
        <div className="max-w-3xl">
            ...
            <div className="mb-8 pb-8 border-b border-zinc-200 dark:border-zinc-800">
                ...
                <p className="text-lg text-zinc-600 dark:text-zinc-400">
                    Command-line interface for managing Boom Antigravity Kit installations.
                </p>
            </div>
            ...
            <section className="mb-12">
                ...
                <p className="text-base text-zinc-600 dark:text-zinc-400 mb-6">
                    The <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">ag-kit</code> CLI tool helps you manage Boom Antigravity Kit installations across your projects.
                </p>
            </section>
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                            Initialize Boom Antigravity Kit in your project by installing the <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">.agent</code> folder.
                        </p>
                    ...
                    <div>
                        ...
                        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                            Update your existing Boom Antigravity Kit installation to the latest version.
                        </p>
