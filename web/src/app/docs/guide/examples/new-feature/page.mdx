export const metadata = {
  title: "Example: Add a New Feature | Boom Antigravity Kit",
  description: "Step-by-step guide on adding new features to an existing application using Boom Antigravity Kit workflows.",
};
